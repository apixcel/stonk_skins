...
import ArrowAngelUp from "../icons/ArrowAngelUp";
    ...
    <div className="w-full h-[823px] relative overflow-hidden">
      ...
      >
        <div className="relative z-[11] w-full h-full flex flex-col items-start justify-center">
          ...
          <button
            className={`relative w-[245px] h-[52px] text-secondary font-[500] text-[16px] leading-[125%] tracking-[-0.096px] mt-[57px] ${fonts.dm_sans.className}`}
          >
