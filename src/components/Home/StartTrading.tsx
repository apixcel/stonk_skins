...
const StartTrading = () => {
  return (
    <div className="mt-[100px] sm:mt-[233px] relative w-full">
      <Image
        src={"/assets/images/ornamentGroup.png"}
        alt=""
        width={1440}
        height={640}
        className=" absolute top-[-154%] left-0 z-[2] hidden sm:block"
      />
      <div className="w-[353px] sm:w-full h-[349px] sm:h-[unset] sm:aspect-[1148/309]  layout_container">
        <div className="relative w-full h-full rounded-[41px] overflow-hidden">
          ...
          <div className="relative z-[5] w-full h-full center flex-col gap-[11px] max-w-[601px] mx-auto">
            <h2 className="text-white text-center text-[32px] sm:text-[48px] font-[500] leading-[118%] tracking-[-2.88px]">
            ...
            >
              Join thousands of gamers already buying, selling, and trading
              skins securely and hassle-free.
            </p>
