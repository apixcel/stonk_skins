...
const ReviewCard = ({ review }: { review: IReview }) => {
  ...
  return (
    <div className="w-[368px] h-[366px] rounded-[24px] border-x-[1.5px] border-t-[1.5px] border-borderPrimary bg-transparent backdrop-blur-[25px] relative flex flex-col justify-between items-start gap-[25px] p-[20px]">
