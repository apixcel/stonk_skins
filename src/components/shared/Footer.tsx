...
import CriclcularGradientIcon from "../icons/CriclcularGradientIcon";
  ...
  return (
    <footer className=" overflow-hidden relative">
        ...
        <div className="mt-[113px] layout_container w-full flex items-start justify-between gap-[32px] flex-col sm:flex-row sm:flex-nowrap flex-wrap">
          <div className="flex flex-col gap-[20px]">
            ...
            <div className="flex items-center justify-start gap-[12px]">
              <Link
                href={"#"}
                className="relative w-[32px] aspect-square center"
              >
                <CriclcularGradientIcon className="absolute  top-0  left-0 z-[1px]" />
                <FacebookIcon className="relative z-[3]" />
              </Link>
              <Link
                href={"#"}
                className="relative w-[32px] aspect-square center"
              ...
              >
                <CriclcularGradientIcon className="absolute  top-0  left-0 z-[1px]" />
                <YouTubeIcon className="relative z-[3]" />
              </Link>
              <Link
                href={"#"}
                className="relative w-[32px] aspect-square center"
              >
                <CriclcularGradientIcon className="absolute  top-0  left-0 z-[1px]" />
                <LinkedinIcon className="relative z-[3]" />
              </Link>
            </div>
          </div>
          <div className="hidden sm:flex flex-col gap-[32px]">
          ...
          {/* smaller device section */}
          <div className="flex sm:hidden w-full items-start justify-between wf">
      ...
      <div className="w-full mt-[41px] bg-borderPrimary">
        <div className="layout_container w-full flex items-center justify-between gap-[32px] py-[22px]  sm:flex-row flex-col ">
          <div
            className={`${fonts.dm_sans.className} flex items-center flex-wrap justify-center sm:justify-start gap-[60px] sm:gap-[25px]`}
          >
            <Link
              href={"#"}
